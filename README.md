...
3. Navigate to your extensions management page by entering 'chrome://extensions/' in the URL address bar.

4. Turn on Developer mode using the toggle switch located in the top-right corner.

5. Click the Load unpacked button in the top-left corner.

5. Select the 'toggle_notepad_chorme_extension' folder that contains your four files.
